...
d=HERE
while d!='/' and not os.path.isdir(os.path.join(d,'draft','latest')): d=os.path.dirname(d)
ALL=os.path.join(d,'draft','latest')
...
def best(fn):
    ...
    return b
S=best('stiles_all.csv'); S['inla_graph_bern_spd']=0.020
