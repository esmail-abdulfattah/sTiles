 ...
 *
 * sTiles is a high-performance framework for efficient linear algebra computations 
 * and symbolic factorization routines, developed and maintained by Esmail Abdul Fattah 
 ...
 * used throughout the sTiles framework.
 *
 * @version 1.0.0
